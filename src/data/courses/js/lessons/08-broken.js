...
console.log(evening);`
  ...
  checks: [
    ...
    // ⚠ Данните ИДВАТ като текст. Кавичките не се махат.
    { id: "t5", type: "src_count", value: '"3"', min: 1, max: 1, err: "erased-source", weight: 700 },
    { id: "t6", type: "src_not_contains", value: "var ", err: "var-left", weight: 650 },
    // Числата се пишат само при създаването на имената.
    { id: "t7", type: "src_count", value: "8", min: 1, max: 1, err: "typed-answer", weight: 600 },
    { id: "t8", type: "src_count", value: "12", min: 1, max: 1, err: "typed-answer", weight: 590 },
    { id: "t9", type: "returns", call: "cups", expect: 20, err: "no-cups", weight: 500 },
    { id: "t10", type: "returns", call: "total", expect: 23, err: "total-glued", weight: 490 },
    { id: "t11", type: "returns", call: "morning", expect: 12, err: "no-swap", weight: 480 },
    { id: "t12", type: "returns", call: "evening", expect: 8, err: "no-swap", weight: 470 },
